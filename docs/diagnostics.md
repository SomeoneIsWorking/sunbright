...
| `SBR_BIND_DECODE_LOG` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:425` |  |
...
| `SBR_DRAW_STATE` | 1 | `sms-recomp/runtime/scene.cpp:812` |  |
...
| `SBR_NO_TEXOBJ` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:391` |  |
...
| `SBR_TEV_TRACE` | 1 | `sms-recomp/runtime/scene.cpp:870` |  |
| `SBR_TEV_TRACE_ADDR` | 1 | `sms-recomp/runtime/scene.cpp:967` |  |
| `SBR_TEV_TRACE_BLACK` | 1 | `sms-recomp/runtime/scene.cpp:877` |  |
| `SBR_TEV_TRACE_FAR` | 1 | `sms-recomp/runtime/scene.cpp:951` |  |
