...
| `SBR_BLACK_OWNER` | 1 | `sms-recomp/overrides/native_frame.cpp:455` |  |
...
| `SBR_DUMP_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:456` |  |
...
| `SBR_INTERP60_BRACKET` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:446` |  |
| `SBR_INTERP60_FOLLOW` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:352` |  |
| `SBR_INTERP60_KICK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:239` |  |
| `SBR_INTERP60_NORESTORE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:198` |  |
| `SBR_INTERP60_TRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:295` |  |
| `SBR_INTERP60_TRACE_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:318` |  |
...
| `SBR_PRESENT_TIMING` | 1 | `sms-recomp/overrides/native_frame.cpp:237` |  |
| `SBR_PROBE` | 1 | `sms-recomp/runtime/probe_server.cpp:240` |  |
| `SBR_PROBE_PORT` | 1 | `sms-recomp/runtime/probe_server.cpp:290` |  |
| `SBR_PTIME_HI` | 1 | `sms-recomp/overrides/native_frame.cpp:261` |  |
| `SBR_PTIME_LO` | 1 | `sms-recomp/overrides/native_frame.cpp:260` |  |
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:302` |  |
| `SBR_RENDER_DEPTHVIZ` | 1 | `sms-recomp/runtime/scene.cpp:69` |  |
| `SBR_RENDER_DUMP` | 1 | `sms-recomp/overrides/native_frame.cpp:458` |  |
...
**294 switches; 69 still gate a raw print.**
