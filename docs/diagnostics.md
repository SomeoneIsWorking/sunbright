...
| `SB_STAGE` | 2 | `sms-recomp/frame_interp/graphics_db.cpp:302` |  |
...
| `SBR_BLACK_OWNER` | 1 | `sms-recomp/overrides/native_frame.cpp:644` |  |
...
| `SBR_DUMP_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:645` |  |
| `SBR_FASTBOOT` | 2 | `sms-recomp/frame_interp/graphics_db.cpp:303` |  |
...
| `SBR_GFXDB_PATH` | 1 | `sms-recomp/frame_interp/graphics_db.cpp:283` |  |
...
| `SBR_PRESENT_TIMING` | 1 | `sms-recomp/overrides/native_frame.cpp:389` |  |
| `SBR_PROBE` | 1 | `sms-recomp/runtime/probe_server.cpp:240` |  |
| `SBR_PROBE_PORT` | 1 | `sms-recomp/runtime/probe_server.cpp:290` |  |
| `SBR_PTIME_HI` | 1 | `sms-recomp/overrides/native_frame.cpp:413` |  |
| `SBR_PTIME_LO` | 1 | `sms-recomp/overrides/native_frame.cpp:412` |  |
| `SBR_QUIT_AFTER` | 1 | `sms-recomp/overrides/native_frame.cpp:458` |  |
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:305` |  |
| `SBR_RENDER_DEPTHVIZ` | 1 | `sms-recomp/runtime/render/scene.cpp:69` |  |
| `SBR_RENDER_DUMP` | 1 | `sms-recomp/overrides/native_frame.cpp:647` |  |
...
| `SBR_STAGE` | 3 | `sms-recomp/frame_interp/graphics_db.cpp:301` |  |
...
| `SBR_TAGWIRE` | 1 | `sms-recomp/frame_interp/tag_deforming.cpp:64` |  |
