...
| `SBR_INTERP60` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:138` |  |
| `SBR_INTERP60_ACTCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:725` |  |
| `SBR_INTERP60_ACTORS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1649` |  |
| `SBR_INTERP60_ACTOR_CALLS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1766` |  |
| `SBR_INTERP60_ACTTALLY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:747` |  |
| `SBR_INTERP60_ALPHA` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:102` |  |
| `SBR_INTERP60_ANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1915` |  |
| `SBR_INTERP60_CALCANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2241` |  |
| `SBR_INTERP60_CALCROOT_SCAN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1698` |  |
| `SBR_INTERP60_CAMFAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1493` |  |
| `SBR_INTERP60_CAMTRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1447` |  |
| `SBR_INTERP60_COPY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2351` |  |
| `SBR_INTERP60_DROPLAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2281` |  |
| `SBR_INTERP60_FOLLOW` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:830` |  |
| `SBR_INTERP60_J3DSYS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1316` |  |
| `SBR_INTERP60_KICK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:650` |  |
| `SBR_INTERP60_LISTS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:875` |  |
| `SBR_INTERP60_MASK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:280` |  |
| `SBR_INTERP60_MOVERS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1746` |  |
| `SBR_INTERP60_NORESTORE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:501` |  |
| `SBR_INTERP60_ORDER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1370` |  |
| `SBR_INTERP60_ORDER_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2087` |  |
| `SBR_INTERP60_PLAYER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1550` |  |
| `SBR_INTERP60_PLAYER_DIFF` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2008` |  |
| `SBR_INTERP60_PREENTRY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2184` |  |
| `SBR_INTERP60_STREAMHASH` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2289` |  |
| `SBR_INTERP60_TRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:773` |  |
| `SBR_INTERP60_TRACE_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:796` |  |
| `SBR_INTERP60_VIEWCALC` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1985` |  |
| `SBR_INTERP60_VIEWSEQ` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1192` |  |
| `SBR_INTERP60_VIEWSEQ_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1197` |  |
| `SBR_INTERP60_VIEWSEQ_MIN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1230` |  |
| `SBR_INTERP60_VIEWWHO` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1321` |  |
...
**323 switches; 69 still gate a raw print.**
