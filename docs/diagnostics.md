...
| switch | sites | first read at | |
|---|---|---|---|
| `SBR_60FPS` | 1 | `sms-recomp/frame_interp/stream_interp.cpp:31` |  |
...
| `SBR_BLACK_OWNER` | 1 | `sms-recomp/overrides/native_frame.cpp:503` |  |
...
| `SBR_DUMP_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:504` |  |
...
| `SBR_LERP60` | 1 | `sms-recomp/frame_interp/stream_interp.cpp:32` |  |
...
| `SBR_PRESENT_TIMING` | 1 | `sms-recomp/overrides/native_frame.cpp:262` |  |
| `SBR_PROBE` | 1 | `sms-recomp/runtime/probe_server.cpp:240` |  |
| `SBR_PROBE_PORT` | 1 | `sms-recomp/runtime/probe_server.cpp:290` |  |
| `SBR_PTIME_HI` | 1 | `sms-recomp/overrides/native_frame.cpp:286` |  |
| `SBR_PTIME_LO` | 1 | `sms-recomp/overrides/native_frame.cpp:285` |  |
| `SBR_QUIT_AFTER` | 1 | `sms-recomp/overrides/native_frame.cpp:331` |  |
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:302` |  |
| `SBR_RENDER_DEPTHVIZ` | 1 | `sms-recomp/runtime/scene.cpp:69` |  |
| `SBR_RENDER_DUMP` | 1 | `sms-recomp/overrides/native_frame.cpp:506` |  |
