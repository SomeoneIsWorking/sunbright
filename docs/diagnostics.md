...
| `SBR_INTERP60` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:135` |  |
| `SBR_INTERP60_ACTCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:722` |  |
| `SBR_INTERP60_ACTORS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1613` |  |
| `SBR_INTERP60_ACTOR_CALLS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1730` |  |
| `SBR_INTERP60_ACTTALLY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:744` |  |
| `SBR_INTERP60_ALPHA` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:102` |  |
| `SBR_INTERP60_ANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1879` |  |
| `SBR_INTERP60_CALCANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2148` |  |
| `SBR_INTERP60_CALCROOT_SCAN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1662` |  |
| `SBR_INTERP60_CAMFAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1490` |  |
| `SBR_INTERP60_CAMTRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1444` |  |
| `SBR_INTERP60_COPY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2258` |  |
| `SBR_INTERP60_DROPLAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2188` |  |
| `SBR_INTERP60_FOLLOW` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:827` |  |
| `SBR_INTERP60_J3DSYS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1313` |  |
| `SBR_INTERP60_KICK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:647` |  |
| `SBR_INTERP60_LISTS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:872` |  |
| `SBR_INTERP60_MASK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:277` |  |
| `SBR_INTERP60_MOVERS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1710` |  |
| `SBR_INTERP60_NORESTORE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:498` |  |
| `SBR_INTERP60_ORDER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1367` |  |
| `SBR_INTERP60_ORDER_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1994` |  |
| `SBR_INTERP60_PLAYER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1547` |  |
| `SBR_INTERP60_PREENTRY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2091` |  |
| `SBR_INTERP60_STREAMHASH` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2196` |  |
| `SBR_INTERP60_TRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:770` |  |
| `SBR_INTERP60_TRACE_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:793` |  |
| `SBR_INTERP60_VIEWCALC` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1949` |  |
| `SBR_INTERP60_VIEWSEQ` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1189` |  |
| `SBR_INTERP60_VIEWSEQ_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1194` |  |
| `SBR_INTERP60_VIEWSEQ_MIN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1227` |  |
| `SBR_INTERP60_VIEWWHO` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1318` |  |
...
**322 switches; 69 still gate a raw print.**
