...
| `SB_TURBO` | 2 | `sms-recomp/overrides/native_frame.cpp:134` |  |
...
| `SBR_BIND_DECODE_LOG` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:630` |  |
| `SBR_BIND_LOG` | 1 | `sms-recomp/runtime/native_render.cpp:220` |  |
| `SBR_BLACK_OWNER` | 1 | `sms-recomp/overrides/native_frame.cpp:491` |  |
...
| `SBR_DUMP_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:492` |  |
| `SBR_FASTBOOT` | 1 | `sms-recomp/overrides/fastboot_native.cpp:79` |  |
| `SBR_FIFO_2D` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:150` |  |
| `SBR_FIFO_STALL` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:1377` |  |
| `SBR_FORCE_DASHBLUR` | 1 | `sms-recomp/overrides/afterimage.cpp:67` |  |
| `SBR_HUD_OFF` | 1 | `sms-recomp/overrides/widescreen.cpp:246` |  |
| `SBR_INTERP60` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:141` |  |
| `SBR_INTERP60_ACTCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:728` |  |
| `SBR_INTERP60_ACTORS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1652` |  |
| `SBR_INTERP60_ACTOR_CALLS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1769` |  |
| `SBR_INTERP60_ACTTALLY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:750` |  |
| `SBR_INTERP60_ALPHA` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:102` |  |
| `SBR_INTERP60_ANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1918` |  |
| `SBR_INTERP60_CALCANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2402` |  |
| `SBR_INTERP60_CALCROOT_SCAN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1701` |  |
| `SBR_INTERP60_CAMFAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1496` |  |
| `SBR_INTERP60_CAMTRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1450` |  |
| `SBR_INTERP60_COPY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2516` |  |
| `SBR_INTERP60_DROPLAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2444` |  |
| `SBR_INTERP60_FOLLOW` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:833` |  |
| `SBR_INTERP60_J3DSYS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1319` |  |
| `SBR_INTERP60_KICK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:653` |  |
| `SBR_INTERP60_LISTS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:878` |  |
| `SBR_INTERP60_MASK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:283` |  |
| `SBR_INTERP60_MOVERS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1749` |  |
| `SBR_INTERP60_MTXCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2075` |  |
| `SBR_INTERP60_MTXTRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2012` |  |
| `SBR_INTERP60_MTXTRACE_ADDR` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2141` |  |
| `SBR_INTERP60_NORESTORE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:504` |  |
| `SBR_INTERP60_ORDER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1373` |  |
| `SBR_INTERP60_ORDER_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2248` |  |
| `SBR_INTERP60_PLAYER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1553` |  |
| `SBR_INTERP60_PLAYER_DIFF` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2169` |  |
| `SBR_INTERP60_PREENTRY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2345` |  |
| `SBR_INTERP60_STREAMHASH` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2454` |  |
| `SBR_INTERP60_TRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:776` |  |
| `SBR_INTERP60_TRACE_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:799` |  |
| `SBR_INTERP60_VIEWCALC` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2058` |  |
| `SBR_INTERP60_VIEWSEQ` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1195` |  |
| `SBR_INTERP60_VIEWSEQ_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1200` |  |
| `SBR_INTERP60_VIEWSEQ_MIN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1233` |  |
| `SBR_INTERP60_VIEWWHO` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1324` |  |
...
| `SBR_NO_TEXOBJ` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:596` |  |
| `SBR_PAD_SCRIPT` | 1 | `sms-recomp/overrides/native_pad.cpp:92` |  |
| `SBR_PHASE_COUNT` | 1 | `sms-recomp/overrides/diag_phases.cpp:25` |  |
| `SBR_PRESENT_AFTER_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:177` |  |
| `SBR_PRESENT_TIMING` | 1 | `sms-recomp/overrides/native_frame.cpp:251` |  |
| `SBR_PROBE` | 1 | `sms-recomp/runtime/probe_server.cpp:240` |  |
| `SBR_PROBE_PORT` | 1 | `sms-recomp/runtime/probe_server.cpp:290` |  |
| `SBR_PTIME_HI` | 1 | `sms-recomp/overrides/native_frame.cpp:275` |  |
| `SBR_PTIME_LO` | 1 | `sms-recomp/overrides/native_frame.cpp:274` |  |
| `SBR_QUIT_AFTER` | 1 | `sms-recomp/overrides/native_frame.cpp:320` |  |
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:302` |  |
| `SBR_RENDER_DEPTHVIZ` | 1 | `sms-recomp/runtime/scene.cpp:69` |  |
| `SBR_RENDER_DUMP` | 1 | `sms-recomp/overrides/native_frame.cpp:494` |  |
...
**326 switches; 69 still gate a raw print.**
