...
| `SBR_BIND_DECODE_LOG` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:622` |  |
...
| `SBR_DRAW_STATE` | 1 | `sms-recomp/runtime/scene.cpp:848` |  |
...
| `SBR_NO_TEXOBJ` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:588` |  |
...
| `SBR_TEV_TRACE` | 1 | `sms-recomp/runtime/scene.cpp:906` |  |
| `SBR_TEV_TRACE_ADDR` | 1 | `sms-recomp/runtime/scene.cpp:1003` |  |
| `SBR_TEV_TRACE_BLACK` | 1 | `sms-recomp/runtime/scene.cpp:913` |  |
| `SBR_TEV_TRACE_FAR` | 1 | `sms-recomp/runtime/scene.cpp:987` |  |
