...
| `SBR_TEV_TRACE` | 1 | `sms-recomp/runtime/scene.cpp:883` |  |
| `SBR_TEV_TRACE_ADDR` | 1 | `sms-recomp/runtime/scene.cpp:980` |  |
| `SBR_TEV_TRACE_BLACK` | 1 | `sms-recomp/runtime/scene.cpp:890` |  |
| `SBR_TEV_TRACE_FAR` | 1 | `sms-recomp/runtime/scene.cpp:964` |  |
