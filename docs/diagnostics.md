...
| `SBR_BLACK_OWNER` | 1 | `sms-recomp/overrides/native_frame.cpp:654` |  |
...
| `SBR_INTERP_CAMONLY` | 1 | `extern/aurora/lib/gfx/interp.cpp:917` |  |
| `SBR_INTERP_TEXMTX` | 1 | `extern/aurora/lib/gfx/interp.cpp:446` |  |
...
| `SBR_PRESENT_TIMING` | 1 | `sms-recomp/overrides/native_frame.cpp:393` |  |
| `SBR_PROBE` | 1 | `sms-recomp/runtime/probe_server.cpp:240` |  |
| `SBR_PROBE_PORT` | 1 | `sms-recomp/runtime/probe_server.cpp:290` |  |
| `SBR_PTIME_HI` | 1 | `sms-recomp/overrides/native_frame.cpp:417` |  |
| `SBR_PTIME_LO` | 1 | `sms-recomp/overrides/native_frame.cpp:416` |  |
| `SBR_QUIT_AFTER` | 1 | `sms-recomp/overrides/native_frame.cpp:462` |  |
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:305` |  |
| `SBR_RENDER_DEPTHVIZ` | 1 | `sms-recomp/runtime/render/scene.cpp:69` |  |
| `SBR_RENDER_DUMP` | 1 | `sms-recomp/overrides/native_frame.cpp:657` |  |
