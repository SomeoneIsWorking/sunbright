...
| `SB_TURBO` | 2 | `sms-recomp/overrides/native_frame.cpp:135` |  |
...
| `SBR_BLACK_OWNER` | 1 | `sms-recomp/overrides/native_frame.cpp:496` |  |
...
| `SBR_DUMP_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:497` |  |
...
| `SBR_INTERP60` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:142` |  |
| `SBR_INTERP60_ACTCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:730` |  |
| `SBR_INTERP60_ACTORS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1656` |  |
| `SBR_INTERP60_ACTOR_CALLS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1773` |  |
| `SBR_INTERP60_ACTTALLY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:752` |  |
| `SBR_INTERP60_ALPHA` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:103` |  |
| `SBR_INTERP60_ANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1922` |  |
| `SBR_INTERP60_CALCANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2643` |  |
...
| `SBR_INTERP60_COPY` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:2480` |  |
| `SBR_INTERP60_DROPLAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2685` |  |
| `SBR_INTERP60_FOLLOW` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:835` |  |
| `SBR_INTERP60_J3DSYS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1323` |  |
| `SBR_INTERP60_KICK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:655` |  |
| `SBR_INTERP60_LISTS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:880` |  |
| `SBR_INTERP60_MASK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:285` |  |
| `SBR_INTERP60_MOVERS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1753` |  |
| `SBR_INTERP60_MTXCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2079` |  |
| `SBR_INTERP60_MTXTRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2016` |  |
| `SBR_INTERP60_MTXTRACE_ADDR` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2183` |  |
| `SBR_INTERP60_NORESTORE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:506` |  |
| `SBR_INTERP60_ORDER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1377` |  |
| `SBR_INTERP60_ORDER_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2295` |  |
| `SBR_INTERP60_PLAYER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1557` |  |
| `SBR_INTERP60_PLAYER_DIFF` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2216` |  |
| `SBR_INTERP60_PREENTRY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2545` |  |
| `SBR_INTERP60_PREENTRY_VC` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2625` |  |
...
| `SBR_INTERP60_REPLACE` | 1 | `sms-recomp/overrides/interp60_replace.cpp:215` |  |
...
| `SBR_INTERP60_REPLACE_NONRM` | 1 | `sms-recomp/overrides/interp60_replace.cpp:160` |  |
| `SBR_INTERP60_STREAMHASH` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2701` |  |
...
| `SBR_INTERP60_VCLIST` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:2129` |  |
| `SBR_INTERP60_VIEWCALC` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2062` |  |
| `SBR_INTERP60_VIEWSEQ` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1199` |  |
| `SBR_INTERP60_VIEWSEQ_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1204` |  |
| `SBR_INTERP60_VIEWSEQ_MIN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1237` |  |
| `SBR_INTERP60_VIEWWHO` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1328` |  |
...
| `SBR_PRESENT_AFTER_COPY` | 1 | `sms-recomp/overrides/native_frame.cpp:182` |  |
| `SBR_PRESENT_TIMING` | 1 | `sms-recomp/overrides/native_frame.cpp:256` |  |
| `SBR_PROBE` | 1 | `sms-recomp/runtime/probe_server.cpp:240` |  |
| `SBR_PROBE_PORT` | 1 | `sms-recomp/runtime/probe_server.cpp:290` |  |
| `SBR_PTIME_HI` | 1 | `sms-recomp/overrides/native_frame.cpp:280` |  |
| `SBR_PTIME_LO` | 1 | `sms-recomp/overrides/native_frame.cpp:279` |  |
| `SBR_QUIT_AFTER` | 1 | `sms-recomp/overrides/native_frame.cpp:325` |  |
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:302` |  |
| `SBR_RENDER_DEPTHVIZ` | 1 | `sms-recomp/runtime/scene.cpp:69` |  |
| `SBR_RENDER_DUMP` | 1 | `sms-recomp/overrides/native_frame.cpp:499` |  |
...
**334 switches; 69 still gate a raw print.**
