...
| `AURORA_DRAW_TRACE` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3256` |  |
...
| `SB_AMB_TRACE` | 2 | `extern/aurora/lib/gx/command_processor.cpp:1666` | gated print |
...
| `SB_CLEAR_OVERRIDE` | 1 | `extern/aurora/lib/gfx/common.cpp:1274` |  |
...
| `SB_CLOUD_TC_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3908` |  |
...
| `SB_DEGEN_DRAW` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2355` |  |
...
| `SB_DRAW_DUMP` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3559` |  |
| `SB_DRAW_DUMP_AFTER` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3571` |  |
| `SB_DRAW_DUMP_ALL` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3583` |  |
| `SB_DRAW_DUMP_FRAME` | 2 | `extern/aurora/lib/gx/command_processor.cpp:3531` |  |
| `SB_DRAW_STATS` | 1 | `extern/aurora/lib/gx/fifo.cpp:81` | gated print |
| `SB_DUMP_FRAME` | 1 | `extern/aurora/lib/aurora.cpp:435` |  |
| `SB_DUMP_FRAME_AFTER` | 1 | `extern/aurora/lib/aurora.cpp:437` |  |
| `SB_DUMP_FRAME_EVERY` | 1 | `extern/aurora/lib/aurora.cpp:446` |  |
...
| `SB_LENS_UV_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2786` |  |
...
| `SB_LIGHT_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3475` |  |
...
| `SB_NDC_MARK` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2525` |  |
| `SB_NDC_PROBE` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2522` |  |
| `SB_NDC_PROBE_AFTER` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2526` |  |
| `SB_NO_ACMP` | 1 | `extern/aurora/lib/gx/gx.cpp:890` |  |
| `SB_NO_ARRCACHE` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4000` |  |
...
| `SB_NO_MERGE` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3058` |  |
...
| `SB_ONLY_DRAW` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3461` |  |
...
| `SB_POS_PROBE` | 1 | `extern/aurora/lib/gx/command_processor.cpp:1974` |  |
...
| `SB_PROFILE_GFX` | 3 | `extern/aurora/lib/aurora.cpp:360` |  |
...
| `SB_PROJ_DUMP` | 1 | `extern/aurora/lib/gx/command_processor.cpp:1815` | gated print |
| `SB_QUAD_RECT` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2014` |  |
...
| `SB_SHADER_HASH` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4077` | gated print |
...
| `SB_SKIP_ADD` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4148` |  |
| `SB_SKIP_ADD_OVERLAY` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3346` |  |
| `SB_SKIP_BF` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3028` | gated print |
| `SB_SKIP_BIGQUAD` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2090` |  |
| `SB_SKIP_COPY_QUAD` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4097` |  |
| `SB_SKIP_COVERING` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2981` |  |
| `SB_SKIP_DUOTONE` | 1 | `decomp/sms/src/JSystem/J2D/J2DPicture.cpp:277` |  |
| `SB_SKIP_FADER` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3390` | gated print |
| `SB_SKIP_GHOST` | 1 | `decomp/sms/src/System/MarDirectorDirect.cpp:340` |  |
| `SB_SKIP_HASH` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4055` |  |
| `SB_SKIP_MARK` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4147` |  |
| `SB_SKIP_MBLACK` | 1 | `decomp/sms/src/JSystem/J2D/J2DPicture.cpp:283` |  |
| `SB_SKIP_MIRROR_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4252` |  |
| `SB_SKIP_MIRROR_FAR` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4250` |  |
| `SB_SKIP_MIRROR_NEAR` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4251` |  |
| `SB_SKIP_OPAQUE_P4` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3360` | gated print |
| `SB_SKIP_ORTHO` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4120` |  |
| `SB_SKIP_PERSP` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4130` |  |
| `SB_SKIP_SCENEQUAD` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3375` | gated print |
| `SB_SKIP_SKY_IDX` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4223` |  |
| `SB_SKIP_TEV3` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3973` |  |
| `SB_SKIP_TEX` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3430` |  |
| `SB_SKIP_TEXDIM` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4178` |  |
| `SB_SKIP_TEXDIM_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4198` | gated print |
| `SB_SKIP_VERTS` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3407` |  |
| `SB_SKIP_WNEG_BF` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2994` |  |
| `SB_SKIP_WNEG_KIND` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3012` |  |
| `SB_SKY_DIM_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:4180` | gated print |
...
| `SB_TEV_DUMP` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3854` | gated print |
...
| `SB_UV_PROBE` | 1 | `extern/aurora/lib/gx/command_processor.cpp:2426` |  |
...
| `SB_XH_GPU_DBG` | 1 | `extern/aurora/lib/gx/command_processor.cpp:3942` |  |
...
| `SBR_BIND_DECODE_LOG` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:421` |  |
...
| `SBR_DIAG_2D` | 1 | `sms-recomp/overrides/diag_2d.cpp:37` |  |
| `SBR_DRAW_STATE` | 1 | `sms-recomp/runtime/scene.cpp:798` |  |
...
| `SBR_NO_TEXOBJ` | 1 | `sms-recomp/runtime/dev_gxfifo.cpp:387` |  |
...
| `SBR_RASTER_SRC` | 1 | `sms-recomp/overrides/j3d_capture.cpp:268` |  |
...
| `SBR_TEV_TRACE` | 1 | `sms-recomp/runtime/scene.cpp:856` |  |
| `SBR_TEV_TRACE_ADDR` | 1 | `sms-recomp/runtime/scene.cpp:953` |  |
| `SBR_TEV_TRACE_BLACK` | 1 | `sms-recomp/runtime/scene.cpp:863` |  |
| `SBR_TEV_TRACE_FAR` | 1 | `sms-recomp/runtime/scene.cpp:937` |  |
