...
| `SBR_INTERP60` | 2 | `sms-recomp/overrides/interp60_snapshot.cpp:122` |  |
| `SBR_INTERP60_ACTCENSUS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:709` |  |
| `SBR_INTERP60_ACTORS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1589` |  |
| `SBR_INTERP60_ACTTALLY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:731` |  |
| `SBR_INTERP60_ALPHA` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:91` |  |
| `SBR_INTERP60_ANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1818` |  |
| `SBR_INTERP60_CALCANIM` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2035` |  |
| `SBR_INTERP60_CALCROOT_SCAN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1638` |  |
| `SBR_INTERP60_CAMTRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1431` |  |
| `SBR_INTERP60_COPY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2115` |  |
| `SBR_INTERP60_DROPLAST` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2061` |  |
| `SBR_INTERP60_FOLLOW` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:814` |  |
| `SBR_INTERP60_J3DSYS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1300` |  |
| `SBR_INTERP60_KICK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:634` |  |
| `SBR_INTERP60_LISTS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:859` |  |
| `SBR_INTERP60_MASK` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:264` |  |
| `SBR_INTERP60_MOVERS` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1686` |  |
| `SBR_INTERP60_NORESTORE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:485` |  |
| `SBR_INTERP60_ORDER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1354` |  |
| `SBR_INTERP60_ORDER_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1914` |  |
| `SBR_INTERP60_PLAYER` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1523` |  |
| `SBR_INTERP60_PREENTRY` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:2010` |  |
| `SBR_INTERP60_TRACE` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:757` |  |
| `SBR_INTERP60_TRACE_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:780` |  |
| `SBR_INTERP60_VIEWSEQ` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1176` |  |
| `SBR_INTERP60_VIEWSEQ_AT` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1181` |  |
| `SBR_INTERP60_VIEWSEQ_MIN` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1214` |  |
| `SBR_INTERP60_VIEWWHO` | 1 | `sms-recomp/overrides/interp60_snapshot.cpp:1305` |  |
...
**318 switches; 69 still gate a raw print.**
