...
| Guest semantic adapters | Copy GMSE01 values through gcnport memory/state interfaces | `title-adapter/include/sunbright/title_adapter/`, `title-adapter/src/` | `guest_j3d_shape.h`: `read_guest_shape`, `read_guest_shape_element`, `guest_mesh_element_source` | `docs/architecture.md` |
