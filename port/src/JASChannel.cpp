// OWNED COPY of reference/sms/src/JSystem/JAudio/JASystem/JASChannel.cpp — keep
// in sync. ONLY 64-bit-port change: the logical TChannel passes itself as the
// owner identity to TDSPChannel::alloc/free via `(u32)this`. That param now
// carries the full host pointer (TDSPChannel::unk8 is the back-pointer returned
// by getLogicalChannel() — see the JASDSPChannel.hpp shadow), widened from u32
// to uintptr_t. Verbatim otherwise.
#include <stdint.h>
