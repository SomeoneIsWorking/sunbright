// OWNED COPY of reference/sms/src/JSystem/JAudio/JASystem/JASDSPBuf.cpp — keep
// in sync. ONLY 64-bit-port change: the DSP output buffer start/end HOST
// addresses passed to DsyncFrame2 were cast `u32(dsp_buf[...])`; widened to
// uintptr_t to match the dsptask.h shadow (and the PAL DsyncFrame2 definition).
// Verbatim otherwise.
#include <stdint.h>
