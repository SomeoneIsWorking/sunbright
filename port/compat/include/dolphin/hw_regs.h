...
// SHADOW (64-bit port): these are AT_ADDRESS hardware MMIO register globals. On
// the host AT_ADDRESS expands to nothing, so the upstream header form is a C++
...
// single real (placeholder) definitions live in port/pal/os/os_globals.cpp.
...
extern volatile u16 __DSPRegs[32] AT_ADDRESS(0xCC005000);
extern volatile u32 __DIRegs[16] AT_ADDRESS(0xCC006000);
