// gx_state_capture.cpp — mirror the GX pixel state the GX compatibility renderer needs.
//
...
SbrDepthState g_zmode{1, 3, 1, 0, 1,
                      0, 1, 1, 0, {0, 0, 640, 448}}; // blend NONE, src ONE, dst ZERO, writes on
