# 2026-08-07 — Native audio: the mixer was easy, the DSP's CLOCK was the work

User: *"can you add audio also?"*, then, on the first version, *"audio is super slowmo"*.

The retired audio path was audible — music and sound effects. Its measurements and binary facts
below remain useful evidence for a future runtime integration.
