# 2026-08-24 — Aurora crash-solidity evidence

## Scope and evidence standard

The priority lane was the integrated guest runtime and Aurora renderer. “Crash-solid” here means the concrete
...
1. **Frame activity was invented instead of observed.** The host ignored the first
...
- The focused runtime test suite passed **17/17** after the renderer and
...
- Full Clang builds completed for both guest-runtime and native-reference targets after the shared array protocol
  changed.
- Guarded real guest-runtime + Aurora runs, each process exit 0 and kernel amdgpu anomaly count
  **42 → 42 (delta 0)**:
